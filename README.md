...
<!--UP_TIME_START-->
```text
Up time: 18 years, 8 months and 27 days
```
<!--UP_TIME_END-->
...
[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=14&pause=1000&color=FFFFFF&multiline=true&width=800&lines="Augment+human+intellect,+amplify+human+potential";–+Douglas+Engelbart,+1968)](https://git.io/typing-svg)
