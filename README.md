...
[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=14&pause=1000&color=FFFFFF&multiline=true&width=800&lines="Impossible+is+just+a+big+word+thrown+around+by+small+men+who+find+it+easier+to+live+in+the+world+they've+been+given+than+to+explore+the+power+they+have+to+change+it.";– Elon Musk, 2024)](https://git.io/typing-svg)
