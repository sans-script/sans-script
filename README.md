...
<!--UP_TIME_START-->
```text
Up time: 18 years, 9 months and 17 days
```
<!--UP_TIME_END-->
...
[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=14&pause=1000&color=FFFFFF&multiline=true&width=800&lines="Embrace+the+uncertain,+forge+your+path";–+John+McCarthy,+2024)](https://git.io/typing-svg)
